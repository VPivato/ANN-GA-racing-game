...
- `analysis.py`: ao executar esse arquivo, um gráfico será gerado a partir de `example_history.jsonl`, como a imagem da seção [Resultados](#resultados)
...
<img src="src/img/results_graph.png" style="width: 700px;" />
