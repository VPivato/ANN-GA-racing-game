...
border_array = pygame.surfarray.array2d(TRACK_BORDER_MASK.to_surface(setcolor=(255,255,255,255), unsetcolor=(0,0,0,0)))
...
class Ray:
    ...
    def cast(self, border_array):
        ...
        hits = np.abs(border_array[xs, ys])
